...
/**
 * Site-wide academic-year scoping, Phase 2 (activity axis). A review points at a
 * course (no year of its own), so each is backfilled to its tenant's first
 * academic year.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $this->backfillTenantFirstYear('reviews');
