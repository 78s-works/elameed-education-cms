...
/**
 * Site-wide academic-year scoping, Phase 2 (activity axis). Attendance rows link
 * only to a center/course (neither carries a year), so each is backfilled to its
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $this->backfillTenantFirstYear('attendance_records');
