...
/**
 * Site-wide academic-year scoping, Phase 2. Course categories are a taxonomy root
 * with no year-bearing parent, so each is backfilled to its tenant's first
 * academic year.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $this->backfillTenantFirstYear('course_categories');
